...
public class Dispersion {
    ...
    Dispersion(final double medianRadius, final int scalingFactor) {
    ...
    public static Dispersion forRadius(final double medianRadius) {
        ...
        return new Dispersion(medianRadius, (int) (1.0 / gauss2r));
    }
